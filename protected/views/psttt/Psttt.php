...
define('PSTTT_DEBUG', false);// uncomment to always enable debugging 
...
class Psttt
{
	...
	var $debug = false;
	var $debug_log;
	var $_modifiers = array('outerHTML','before','after','append','deleteAllButFirst','delete','if_exists','hide');
	...
	function append(&$node_list, $html = false)
	{
		foreach ($node_list as $node)
		{
			if($html == '') continue;
